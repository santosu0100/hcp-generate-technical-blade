...
const COMPONENT_LIST: { type: ComponentType, icon: string, label: string, desc: string, category: ComponentCategory }[] = [
  ...
  { type: 'card', icon: '⭐️', label: 'Cartão', desc: 'Placar/Card de Valores', category: ComponentCategory.COMPONENTS },
  { type: 'ordered-description', icon: '⏱️', label: 'Descrição Ordenada', desc: 'Etapas passo a passo (Linha do Tempo)', category: ComponentCategory.COMPONENTS },
  { type: 'link', icon: '🔗', label: 'Link', desc: 'Texto clicável (URL)', category: ComponentCategory.COMPONENTS },
  { type: 'table', icon: '📊', label: 'Tabela', desc: 'Grade de dados estruturada', category: ComponentCategory.COMPONENTS },
  ...
  { type: 'big-int', icon: '🔢', label: 'Número em Destaque', desc: 'Dado de alto impacto (ex. 21%)', category: ComponentCategory.COMPONENTS },
